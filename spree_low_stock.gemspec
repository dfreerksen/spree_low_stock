...
require 'spree_low_stock/version'

Gem::Specification.new do |spec|
  spec.platform    = Gem::Platform::RUBY
  spec.name        = 'spree_low_stock'
  spec.version     = SpreeLowStock::VERSION
  spec.authors     = ['David Freerksen']
  spec.homepage    = 'http://github.com/groundctrl/spree_low_stock'
  spec.summary     = 'Low stock notifications for products.'
